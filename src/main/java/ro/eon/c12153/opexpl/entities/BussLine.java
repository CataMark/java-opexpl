 ...
 * @author C12153
 */
public class BussLine implements Serializable{
    private static final long serialVersionUID = 1L;
    
    //database table field names
    private static final String COD = "cod";
    private static final String SEGMENT = "seg_ind";
    ...
    public BussLine(Map<String, Object> inreg){
    ...
    public BussLine(String json, boolean encoded) throws Exception{
    ...
    public BussLine(JsonObject json) throws Exception{
        this.parseJson(json);
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 59 * hash + Objects.hashCode(this.cod);
        hash = 59 * hash + Objects.hashCode(this.segment);
        hash = 59 * hash + Objects.hashCode(this.nume);
        hash = 59 * hash + Objects.hashCode(this.mod_de);
        hash = 59 * hash + Objects.hashCode(this.mod_timp);
        return hash;
    }
