 ...
 * @author C12153
 */
public class PlanVers implements Serializable{
    ...
    public PlanVers(Map<String, Object> inreg){
    ...
    public PlanVers(String json, boolean encoded) throws Exception{
    ...
    public PlanVers(JsonObject json) throws Exception{
        this.parseJson(json);
    }
