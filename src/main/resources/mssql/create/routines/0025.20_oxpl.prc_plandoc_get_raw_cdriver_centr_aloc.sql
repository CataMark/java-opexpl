create or alter procedure oxpl.prc_plandoc_get_raw_cdriver_centr_aloc
    @set int,
    @hier char(5),
    @cdriver char(5),
    @ocateg int = null
as
    begin
        ...
        on a.hier = c.hier and a.data_set = c.data_set and a.cost_centre = c.cod
        ...
        where a.data_set = @set and a.hier = @hier and d.cost_driver = @cdriver and
