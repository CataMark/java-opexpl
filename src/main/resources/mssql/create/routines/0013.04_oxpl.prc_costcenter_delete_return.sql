create or alter procedure oxpl.prc_costcenter_delete_return
    @id uniqueidentifier,
    @kid varchar(20)
as
    begin
        ...
        delete from oxpl.tbl_int_ccntr where id = @id;

        /* testare operatiunea a reusit */
        if exists (select * from oxpl.tbl_int_ccntr where id = @id)
